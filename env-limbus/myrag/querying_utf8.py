...
'N사 E.G.O::흉탄 이상 000(3성)'-(고유 키워드):'흉탄','찢어진 추억', -(키워드):'흉탄','찢어진 추억','호흡','출혈' '파불코'.

'홍원 군주 홍루 000(3성) –시즌 하이라이트'-(키워드):'사중구활','존명','몰아침','뜻에 따라 베겠습니다',
...
- 제 1회 발푸르기스의 밤(제1회 발푸밤 이벤트명(제1회 발푸르기스의 밤 이벤트는 인격명이 없습니다)(인격: '로보토미 E.G.O::후회 파우스트 000(3성)', '갈고리 사무소 해결사 홍루 00 (2성)',
  에고(E.G.O): '후회 (뫼르소, TETH 등급)')
- 제 2회 발푸르기스의 밤 (인격: '로보토미 E.G.O::마탄 오티스 000(3성)', '로보토미 E.G.O::초롱 돈키호테 00(2성)')

- 제 3회 발푸르기스의 밤:(인격: '새벽 사무소 해결사 싱클레어 000(3성)-(전용키워드): 불안정한 격정: 공격 적중시 화상 1 부여, 메인타겟에 화상이 있으면 최종위력 +1, 수비 스킬을 연결하고 전투를 시작하면, 해당 턴동안 피격시 공격자에게 화상 1 부여, 턴 종료시 정신력이 (변신 유지턴 수 * 5)만큼 감소 (최대 정신력 감소량:40),-(키워드):화상,불안정한 격정',
  에고(E.G.O): '날갯짓 (이스마엘, HE 등급)', '핏빛욕망 (로쟈, WAW 등급)').

- 제 4회 발푸르기스의 밤:(인격: '로보토미 E.G.O::적안 참회 료슈 000(3성)', '로보토미 E.G.O::엄숙한 애도 이상 000(3성)',
  에고(E.G.O): '엄숙한 애도 (그레고르, HE 등급)').

- 제 5회 발푸르기스의 밤:(인격: '마침표 사무소 대표 홍루 000(3성)', '마침표 사무소 해결사 히스클리프 000(3성)',
  에고(E.G.O): '마탄 (오티스, HE 등급)').

- 제 6회 발푸르기스의 밤:(인격: '로보토미 E.G.O::사랑과 증오의 이름으로 돈키호테 000(3성)',
...
17) 인격에 -(전용키워드), -(키워드), -(패시브), -(스킬)이 각각  입력 되지 않은 경우 "[키워드] 정보가 아직  갱신되지 않았습니다", "[스킬] 정보가 아직 갱신되지 않습니다.", "[패시브] 정보가 아직 갱신되지 않았습니다."라고 답변할것."
18)로보토미 E.G.O::사랑과 증오의 이름으로 돈키호테 000(3성)인격은 '증여 돈' ,'증여돈', '증여 돈키호테' 라고도 불립니다.
